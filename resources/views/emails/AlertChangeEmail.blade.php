            ...
            <tr>
              <td style="padding: 32px; color: #333">
                <h2 style="margin-top: 0; font-size: 22px; color: #d9534f">
                  ¡El correo de tu cuenta ha sido cambiado!
                </h2>
                ...
                <p style="font-size: 16px; margin-bottom: 24px;">
                  Te informamos que el correo de tu cuenta en <strong>ECOSORT</strong> fue actualizado recientemente, de <strong>{{ $previousEmail }}</strong> a <strong>{{ $newEmail }}</strong>.
                </p>

...
const { loading, deleteContainer } = useDeleteContainer()
...
const confirmDelete = async () => {
  if (await deleteContainer(props.data.id)) {
    emit('delete', true)
    isOpen.value = false
  }
}
      ...
      <VCardText>
        <div class="flex flex-col items-center gap-2">
          <VAlert
            ...
            variant="tonal"
          >
            Si el contenedor tiene elementos asignados, no se podrá eliminar.
          </VAlert>

          <div class="text-lg">
            ¿Estás seguro de que deseas eliminar el contenedor
